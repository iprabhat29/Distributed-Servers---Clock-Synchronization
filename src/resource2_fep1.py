...
class votingResults(Resource):
    ...
    def read(self, request, id):
        ...
        print 'Time difference of Fep 1 Server',t-t1
        print 'Time difference of Fep 2 Server',t-t2
        print 'Time difference of Backend Server',t-t3
